...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Hotel Bandung | Log in</title>
  ...
  <body class="login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="index.php"><b>BDG</b>HOTEL</a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        ...
        <form action="" method="post">
          ...
          <div class="row">
            ...
            <div class="col-xs-4">
              <button name="login" type="submit" class="btn btn-primary btn-block btn-flat">Login <i class="fa fa-sign-in"></i></button>
            </div><!-- /.col -->
          </div>
        </form>
