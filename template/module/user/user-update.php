	...
	<div class="box">
		<form action="" method="post">
			...
			<div class="box-footer">
				...
				<button class="btn btn-success" type="submit" name="user-update">Update User <i class="fa fa-check"></i></button>
				<a class="btn btn-danger" href="?module=user/user-delete&user=<?php echo $user_view['id_user']; ?>">Hapus <i class="fa fa-trash"></i></a>
