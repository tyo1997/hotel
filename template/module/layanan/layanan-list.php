...
<section class="content">
	<div class="box">
		<div class="box-header">
			<a class="btn btn-primary" href="?module=layanan/layanan-add">Tambah Layanan Baru <i class="fa fa-plus"></i></a>
		</div>
		<div class="box-body">
			<table class="table table-striped table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a class="btn btn-xs btn-info" href="?module=layanan/layanan-update&layanan=<?php echo $layanan['id_layanan']; ?>">Ubah <i class="fa fa-pencil"></i></a>
						</td>
					</tr>
					<?php } ?>
				</tbody>
