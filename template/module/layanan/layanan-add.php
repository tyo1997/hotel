				...
				<div class="row">
					<div class="col-sm-4">
						<div class="form-group">
							...
							<input class="form-control" name="nama_layanan" autocomplete="off"/>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label>Satuan</label>
							<input class="form-control" name="satuan" autocomplete="off"/>
						</div>
						<div class="form-group">
							<label>Harga</label>
							<input class="form-control" name="harga_layanan" autocomplete="off"/>
						</div>
					</div>
				</div>
			</div>
			<div class="box-footer">
				<button class="btn btn-primary" type="submit" name="layanan-add">Tambah Layanan <i class="fa fa-plus"></i></button>
				<a class="btn btn-warning" href="?module=layanan/layanan-list">Batal <i class="fa fa-close"></i></a>
			</div>
		</div>
	</form>
	<?php } ?>
