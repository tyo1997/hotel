	...
	<form action="" method="post">
		<div class="box">
			...
			<div class="box-footer">
				...
				<button class="btn btn-success" type="submit" name="layanan-update">Update Layanan <i class="fa fa-check"></i></button>
				<a class="btn btn-danger" href="?module=layanan/layanan-delete&layanan=<?php echo $layanan_view['id_layanan']; ?>">Hapus <i class="fa fa-trash"></i></a>
