			...
			<div class="box">
				<form action="" method="post">
					...
					<div class="box-footer">
						<button class="btn btn-primary" type="submit" name="layanankat-add">Tambah Kategori <i class="fa fa-plus"></i></button>
						<button class="btn btn-warning" type="reset">Batal <i class="fa fa-close"></i></button>
					</div>
				</form>
			</div>
		</div>
			...
			<div class="box">
				...
				<form action="" method="post">
					...
					<div class="box-footer">
						...
						<button class="btn btn-primary" type="submit" name="layanankat-update">Update Kategori <i class="fa fa-check"></i></button>
						<a class="btn btn-danger" href="?module=layanan/kategori-delete&layanan-kategori=<?php echo $layanan_kategori_view['id_layanan_kategori']; ?>">Hapus <i class="fa fa-trash"></i></a>
						<a class="btn btn-warning" href="?module=layanan/kategori-list">Batal <i class="fa fa-close"></i></a>
					</div>
				</form>
				<?php } } else { ?>
				<div class="box-body">
					<table class="table table-striped table-hover">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a class="btn btn-xs btn-info" href="?module=layanan/kategori-list&layanan-kategori=<?php echo $layanan_kategori['id_layanan_kategori']; ?>">Ubah <i class="fa fa-pencil"></i></a>
								</td>
							</tr>
							<?php } ?>
						</tbody>
