...
<section class="content">
	<div class="box">
		<div class="box-header">
			<a class="btn btn-primary" href="?module=kamar/tipe-add">Tambah Tipe Kamar <i class="fa fa-plus"></i></a>
		</div>
		<div class="box-body">
			<table class="table table-bordered table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td><a class="btn btn-info btn-xs" href="?module=kamar/tipe-update&kamar-tipe=<?php echo $kamar_tipe['id_kamar_tipe']; ?>">Ubah <i class="fa fa-pencil"></i></a></td>
					</tr>
					<?php } ?>
				</tbody>
			</table>
