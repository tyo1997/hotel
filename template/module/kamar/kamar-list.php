...
<section class="content">
	<div class="box">
		<div class="box-header">
			<a class="btn btn-primary" href="?module=kamar/kamar-add">Tambah Kamar <i class="fa fa-plus"></i></a>
		</div>
		<div class="box-body">
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a href="?module=kamar/kamar-update&kamar=<?php echo $kamar['id_kamar']; ?>" class="btn btn-xs btn-info">Ubah <i class="fa fa-pencil"></i></a>
						</td>
					</tr>
					<?php } ?>
				</tbody>
