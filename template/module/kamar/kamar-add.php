	...
	<form action="" method="post">
		<div class="box">
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="form-group">
							...
							<input class="form-control" name="nomor_kamar" autocomplete="off" required />
						</div>
						<div class="form-group">
			...
			<div class="box-footer">
				<button class="btn btn-primary" type="submit" name="kamar-add">Tambah Kamar <i class="fa fa-plus"></i></button>
