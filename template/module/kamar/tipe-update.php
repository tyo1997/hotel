	...
	<form action="" method="post">
		<div class="box">
			...
			<div class="box-footer">
				...
				<button class="btn btn-success" type="submit" name="kamartipe-update">Update <i class="fa fa-check"></i></button>
				<a class="btn btn-danger" href="?module=kamar/tipe-delete&kamar-tipe=<?php echo $kamar_tipe_view['id_kamar_tipe']; ?>">Hapus <i class="fa fa-trash"></i></a>
