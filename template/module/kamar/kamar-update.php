	...
	<form action="" method="post">
		<div class="box">
			...
			<div class="box-footer">
				...
				<button class="btn btn-success" type="submit" name="kamar-update">Update Kamar <i class="fa fa-check"></i></button>
				<a class="btn btn-danger" href="?module=kamar/kamar-delete&kamar=<?php echo $kamar_view['id_kamar']; ?>">Hapus Kamar <i class="fa fa-trash"></i></a>
				<a class="btn btn-warning" href="?module=kamar/kamar-list">Batal <i class="fa fa-close"></i></a>
			</div>
		</div>
	</form>
	<?php } ?>
