	...
	<div class="box">
		...
		<form action="" method="post">
			...
			<div class="box-footer">
				...
				<button class="btn btn-info" type="submit" name="checkin-update">Ubah Data <i class="fa fa-pencil"></i></button>
				<a class="btn btn-warning" href="?module=transaksi/checkin-list">Batal <i class="fa fa-close"></i></a>
			</div>
		</form>
		<?php } ?>
	</div>
