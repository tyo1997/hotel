			...
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td><a class="btn btn-xs btn-info" href="?module=transaksi/checkin-update&transaksi=<?php echo $tamu_inhouse['id_transaksi_kamar']; ?>&kamar=<?php echo $tamu_inhouse['id_kamar']; ?>">Ubah <i class="fa fa-pencil"></i></a></td>
					</tr>
					<?php } ?>
				</tbody>
			</table>
