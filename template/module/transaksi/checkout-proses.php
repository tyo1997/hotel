		...
		<form action="" method="post">
			<div class="box-body">
				...
				<table class="table table-striped">
					...
					<tbody>
						<tr>
							<td>Jenis kamar yang dipesan : <?php echo $transaksi_kamar['nama_kamar_tipe'].' ROOM'; ?></td>
			...
			<div class="box-footer">
				...
				<button class="btn btn-success" type="submit" name="checkout">Check Out <i class="fa fa-paper-plane-o"></i></button>
				<a class="btn btn-primary" href="?report=transaksi-tamu&transaksi=<?php echo $transaksi_kamar['id_transaksi_kamar']; ?>" target="_blank">Cetak Invoice <i class="fa fa-print"></i></a>
				<a class="btn btn-warning" href="?module=transaksi/checkin">Batal <i class="fa fa-close"></i></a>
			</div>
		</form>
		<?php } ?>
	</div>
