...
<section class="content">
	<div class="box">
		<div class="box-header">
			...
			<a class="btn btn-warning pull-right" href="?module=transaksi/pesan-layanan">Batal <i class="fa fa-close"></i></a>
		</div>
		<div class="box-body">
				...
				<tbody>
					...
					<form action="" method="post">
						...
						<tr>
							...
							<td>
								<button class="btn btn-xs btn-success" type="submit" name="pesan-layanan">Pesan <i class="fa fa-shopping-cart"></i></button>
							</td>
						</tr>
					</form>
					<?php } ?>
