...
<section class="content">
	<div class="box">
		<div class="box-header">
			<a class="btn btn-primary" href="?module=tamu/tamu-add">Tambah Tamu Baru <i class="fa fa-plus"></i></a>
		</div>
		<div class="box-body">
			<table class="table table-striped table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a class="btn btn-xs btn-info" href="?module=tamu/tamu-update&tamu=<?php echo $tamu['id_tamu']; ?>">Ubah <i class="fa fa-pencil"></i></a>
						</td>
					</tr>
					<?php } ?>
				</tbody>
