	...
	<div class="box">
		<form action="" method="post">
			...
			<div class="box-footer">
				...
				<button class="btn btn-success" type="submit" name="tamu-update">Update Tamu <i class="fa fa-check"></i></button>
				<a class="btn btn-danger" href="?module=tamu/tamu-delete&tamu=<?php echo $tamu_view['id_tamu']; ?>">Hapus <i class="fa fa-trash"></i></a>
